...
(function ($, undefined) {
	...
	$.widget('ui.tabs', {
		...
		_tabify: function (init) {
			...
			// Reset certain styles leftt over from animation
		...
		remove: function (index) {
			...
			// If selected tab was removed focus tab to the rightt or
			// in case the last tab was removed the tab to the leftt.
