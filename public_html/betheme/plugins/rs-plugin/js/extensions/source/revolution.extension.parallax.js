...
(function ($) {
	...
	jQuery.extend(true, _R, {
			...
			opt.li.each(function () {
				...
				if (_.type == '3D' || _.type == '3d') {
					li.find('.slotholder').wrapAll(
						'<div class="dddwrapper" style="width:100%;height:100%;position:absolute;top:0px;right:0px;overflow:hidden"></div>'
					);
					li.find('.tp-parallax-wrap').wrapAll(
						'<div class="dddwrapper-layer" style="width:100%;height:100%;position:absolute;top:0px;right:0px;z-index:5;overflow:' +
					...
					li.find('.rs-parallaxlevel-tobggroup')
						...
						.wrapAll(
							'<div class="dddwrapper-layertobggroup" style="position:absolute;top:0px;right:0px;z-index:50;width:100%;height:100%"></div>'
						);
		...
		scrollHandling: function (opt, fromMouse) {
			...
			if (opt.lastscrolltop == st && !opt.duringslidechange && !fromMouse)
				return false;
