...
const fa_lang = {
  ...
  dialog: {
    ...
    inventory: {
      ...
      total_price: "قیمت کل",
      actions: "عملیات",
      duplicate_item: "این کالا قبلاً در لیست انتخاب شده است",
      save_success: "موجودی کالا با موفقیت ذخیره شد",
      save_error: "خطا در ذخیره موجودی کالا",
      delete_confirm: "آیا از حذف این کالا اطمینان دارید؟",
      delete_success: "کالا با موفقیت حذف شد",
      delete_error: "خطا در حذف کالا",
  ...
  pages: {
    ...
    manager: {
      ...
      sms_settings_repservice_getback: "تحویل کالا",
