  ...
  <div class="block block-content-full ">
    <div id="fixed-header" class="block-header block-header-default bg-gray-light pt-2 pb-1">
      ...
      <div class="block-options">
        ...
        <router-link to="/acc/rfsell/mod/" type="button" class="block-options-item">
        ...
        <div class="col-sm-12 col-md-12 m-0 p-0">
          ...
          <EasyDataTable table-class-name="customize-table" v-model:items-selected="itemsSelected" show-index
            ...
            <template #item-code="{ code }">
              <router-link :to="'/acc/rfsell/view/' + code">
                {{ code }}
              </router-link>
            </template>
          </EasyDataTable>
 ...
 methods: {
   changeLabel(label) {
     if (this.itemsSelected.length == 0) {
       ...
       this.loading = true;
       axios.post('/api/rfsell/label/change', {
   ...
   loadData() {
     ...
     axios.post('/api/rfsell/docs/search', {
       type: 'rfsell'
     })
       .then((response) => {
   ...
   printInvoice(pdf = true,cloudePrinters=true) {
     this.loading = true;
     axios.post('/api/rfsell/print/invoice', { 
